...
// --- Page palette (self-contained: no external packages required) ----------
const Color _gradientStart = Color(0xFFF5F7FA);
const Color _gradientEnd = Color(0xFFC3CFE2);

const Color _eventAccent = Color(0xFF3B82F6); // blue
const Color _communityAccent = Color(0xFF22C55E); // green

const Color _textPrimary = Color(0xFF222222);
const Color _textSecondary = Color(0xFF707070);
...
class CreateSelectionPage extends StatelessWidget {
  const CreateSelectionPage({super.key});
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border: Border.all(color: const Color(0x1A000000)), // black @ 10%
          ),
          child: Row(
            children: [
              // Icon badge
...
class _ProTip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0x14FFB300), // amber @ 8%
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: const Color(0x33FFB300)), // amber @ 20%
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
