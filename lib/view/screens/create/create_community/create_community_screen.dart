...
import 'package:test_project/view/screens/create/create_community/widgets/community_category_selector.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              EventFormField(label: 'Description', controller: _dateController, hintText: 'What is this community about?',maxLines: 5,),
              const SizedBox(height: 18),
              CommunityCategorySelector(
                onChanged: (selected) {
                  // wire this to your state/bloc, e.g.:
                  // context.read<CreateCommunityBloc>().add(CategoriesChanged(selected));
                  debugPrint('Selected categories: $selected');
                },
              ),
              const SizedBox(height: 18,),
              EventFormField(
