...
import 'package:test_project/onboarding_final_screen.dart';
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          ...
                          gradient: const LinearGradient(
                            ...
                            colors: [
                              Color(0xFF5AC8FA), // cyan-blue left
                              Color(0xFF9B59F5), // purple right
                            ],
                          ),
                          boxShadow: [
                            BoxShadow(
                              color:
                                  const Color(0xFF9B59F5).withValues(alpha: 0.35),
                              blurRadius: 20,
